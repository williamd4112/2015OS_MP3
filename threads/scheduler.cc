...
Scheduler::ReadyToRun (Thread *thread)
{
    ...
    fprintf(logFile, "Tick %d: Thread %d is inserted into queue L1\n",kernel->stats->totalTicks, thread->getID());
...
Scheduler::FindNextToRun ()
{
    ...
    else
    {
        ...
        fprintf(logFile, "Tick %d: Thread %d is removed from queue L1\n",
          kernel->stats->totalTicks, thread->getID());
...
Scheduler::Run (Thread *nextThread, bool finishing)
{
    ...
    fprintf(logFile, "Tick %d: Thread %d is now selcted for execution (Start at %d)\n",
      kernel->stats->totalTicks,
      kernel->currentThread->getID(),
      kernel->currentThread->lastCPUTick);
